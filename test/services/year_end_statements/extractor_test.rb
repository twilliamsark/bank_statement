...
class CCYearEndStatement::ExtractorTest < ActiveSupport::TestCase
  ...
  test "keeps category context across continued pages and handles credits and missing spaces" do
  ...
  test "treats a repeated category heading as a subcategory" do
    result = extract_sample
  ...
  test "returns a flat transaction list with category and subcategory names" do
    result = extract_sample
  ...
  test "extracts the Bank of America year-end summary when the session file is present" do
